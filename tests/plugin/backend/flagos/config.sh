#!/usr/bin/env bash
# FlagOS Backend Test Configuration

set -euo pipefail

readonly PLATFORM_NAME="flagos"
readonly PLATFORM_DISPLAY_NAME="FlagOS"
...
readonly PLATFORM_PYTEST_PATH="tests/plugin/backend/flagos"
