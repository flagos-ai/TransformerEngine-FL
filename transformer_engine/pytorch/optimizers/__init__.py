...
from transformer_engine.plugins.cpp_extensions import fl_multi_tensor_l2_norm as multi_tensor_l2norm
from transformer_engine.plugins.cpp_extensions import fl_multi_tensor_scale as multi_tensor_scale
