...
from transformer_engine.pytorch.backend.modules.multi_tensor_apply import te_fl_multi_tensor_l2_norm as multi_tensor_l2norm
from transformer_engine.pytorch.backend.modules.multi_tensor_apply import te_fl_multi_tensor_scale as multi_tensor_scale
