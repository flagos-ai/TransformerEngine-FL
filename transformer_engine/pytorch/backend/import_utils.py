...
def safety_import(module_path: str, name: Optional[str] = None, lazy: bool = False) -> Any:
    ...
    Args:
        module_path: Full module path (e.g., 'transformer_engine.pytorch.backend.flash_attn')
    ...
    Examples:
        ...
        # Import a module
        flash_attn_module = safety_import('transformer_engine.pytorch.backend.flash_attn')
    """
