...
### GEMM
te_fl_general_gemm = safety_import('transformer_engine.extensions.modules.gemm', 'te_fl_general_gemm')
### RMSNORM
gems_rmsnorm_fwd = safety_import('transformer_engine.extensions.modules.gems_rms_norm', 'rms_norm_forward')
gems_rmsnorm_bwd = safety_import('transformer_engine.extensions.modules.gems_rms_norm', 'rms_norm_backward')
### AdamW
te_fl_multi_tensor_adam = safety_import('transformer_engine.extensions.modules.fused_adam', 'te_fl_multi_tensor_adam')
### Flash-Attn
