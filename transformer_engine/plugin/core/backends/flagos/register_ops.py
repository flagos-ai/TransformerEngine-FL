...
def register_builtins(registry) -> None:
    ...
    impls = [
        ...
        # MOE operations
        OpImpl(op_name="moe_permute_fwd", impl_id="default.flagos", kind=BackendImplKind.DEFAULT, fn=_bind_is_available(backend.moe_permute_fwd, is_avail), vendor=None, priority=150),
        OpImpl(op_name="moe_unpermute_bwd", impl_id="default.flagos", kind=BackendImplKind.DEFAULT, fn=_bind_is_available(backend.moe_unpermute_bwd, is_avail), vendor=None, priority=150),
        OpImpl(op_name="moe_permute_bwd", impl_id="default.flagos", kind=BackendImplKind.DEFAULT, fn=_bind_is_available(backend.moe_permute_bwd, is_avail), vendor=None, priority=150),
        OpImpl(op_name="moe_unpermute_fwd", impl_id="default.flagos", kind=BackendImplKind.DEFAULT, fn=_bind_is_available(backend.moe_unpermute_fwd, is_avail), vendor=None, priority=150),
