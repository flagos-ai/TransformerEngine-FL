...
class AttnFuncASCEND(torch.autograd.Function):
    @staticmethod
    def forward(
        ctx,
        is_training,
        ...
        nvtx_label = "transformer_engine.AttnFuncASCEND.forward"
        ...
        # Must be contiguous for .view() in FlashAttentionASCEND.forward
...
class FlashAttentionASCEND(FlashAttentionBase):
    def __init__(
        self,
        softmax_scale: float,
