...
"""
Enflame vendor backend operator registrations.

This module registers all VENDOR (Enflame vendor backend operator registrations.
) implementations from transformer_engine_torch.
"""
...
def register_builtins(registry) -> None:
    """
    Register all Enflame (VENDOR) operator implementations.

    Args:
        registry: Registry to register into
    """
    # Import Enflame backend to get all the wrapped tex functions
    from .enflame import EnflameBackend

    # Create a backend instance to access the methods
    backend = EnflameBackend()

    # Check if Enflame is available before registering
    ...
    impls = [
        ...
        OpImpl(
            op_name="rmsnorm_bwd_add",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.rmsnorm_bwd_add, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
        ...
        OpImpl(
            ...
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.dequantize, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="bgrad_quantize",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.bgrad_quantize, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="group_quantize",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.group_quantize, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="bgrad_group_quantize",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.bgrad_group_quantize, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="split_quantize",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.split_quantize, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        # Activations - Forward
        ...
        # MOE operations
        OpImpl(
            op_name="moe_permute_fwd",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.moe_permute_fwd, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="moe_permute_bwd",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.moe_permute_bwd, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="moe_unpermute_fwd",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.moe_unpermute_fwd, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="moe_unpermute_bwd",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.moe_unpermute_bwd, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        # Fused attention
        ...
        OpImpl(
            op_name="fused_attn_fwd",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.fused_attn_fwd, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="fused_attn_bwd",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.fused_attn_bwd, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="fa_prepare_fwd",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.fa_prepare_fwd, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="fa_prepare_bwd",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.fa_prepare_bwd, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        # KV cache
        OpImpl(
            op_name="copy_to_kv_cache",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.copy_to_kv_cache, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        ...
        OpImpl(
            op_name="fused_topk_with_score_function_fwd",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.fused_topk_with_score_function_fwd, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            ...
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.fused_topk_with_score_function_bwd, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="fused_score_for_moe_aux_loss_fwd",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.fused_score_for_moe_aux_loss_fwd, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="fused_score_for_moe_aux_loss_bwd",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.fused_score_for_moe_aux_loss_bwd, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="fused_moe_aux_loss_fwd",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.fused_moe_aux_loss_fwd, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="fused_moe_aux_loss_bwd",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.fused_moe_aux_loss_bwd, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        # Dropout
        ...
        # FP8 operations
        OpImpl(
            op_name="fp8_transpose",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.fp8_transpose, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="swap_first_dims",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.swap_first_dims, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="nvfp4_data_transpose",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.nvfp4_data_transpose, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="swizzle_scales_for_gemm_",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.swizzle_scales_for_gemm_, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="grouped_swizzle_for_gemm",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.grouped_swizzle_for_gemm, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
        ...
        OpImpl(
            op_name="compute_amax",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.compute_amax, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="fused_amax_and_scale_update_after_reduction",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.fused_amax_and_scale_update_after_reduction, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="fp8_block_scaling_compute_partial_amax",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.fp8_block_scaling_compute_partial_amax, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="fp8_block_scaling_partial_cast",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.fp8_block_scaling_partial_cast, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="mxfp8_scaling_compute_partial_amax",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.mxfp8_scaling_compute_partial_amax, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="mxfp8_scaling_partial_cast",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.mxfp8_scaling_partial_cast, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="nvfp4_2d_compute_partial_amax",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.nvfp4_2d_compute_partial_amax, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="nvfp4_multi_tensor_compute_partial_amax",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.nvfp4_multi_tensor_compute_partial_amax, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="nvfp4_compute_global_scale",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.nvfp4_compute_global_scale, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="nvfp4_compute_per_block_scale",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.nvfp4_compute_per_block_scale, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="nvfp4_expand_scale_to_fp8",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.nvfp4_expand_scale_to_fp8, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="nvfp4_fused_scale",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.nvfp4_fused_scale, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="nvfp4_multi_tensor_fused_scale",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.nvfp4_multi_tensor_fused_scale, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="nvfp4_2d_partial_cast",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.nvfp4_2d_partial_cast, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="nvfp4_multi_tensor_2d_partial_cast",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.nvfp4_multi_tensor_2d_partial_cast, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="nvfp4_2d_multi_tensor_transpose",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.nvfp4_2d_multi_tensor_transpose, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        # Padding operations
        OpImpl(
            op_name="fused_multi_row_padding",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.fused_multi_row_padding, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="fused_multi_row_unpadding",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.fused_multi_row_unpadding, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        ...
        OpImpl(
            op_name="thd_read_half_tensor",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.thd_read_half_tensor, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="thd_second_half_lse_correction",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.thd_second_half_lse_correction, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="thd_read_second_half_lse",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.thd_read_second_half_lse, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="thd_out_correction",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.thd_out_correction, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="thd_grad_correction",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.thd_grad_correction, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
        ...
        # NVSHMEM operations
        OpImpl(
            op_name="init_nvshmem_backend",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.init_nvshmem_backend, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="create_nvshmem_tensor",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.create_nvshmem_tensor, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="nvshmem_send_on_current_stream",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.nvshmem_send_on_current_stream, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="nvshmem_wait_on_current_stream",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.nvshmem_wait_on_current_stream, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="nvshmem_finalize",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.nvshmem_finalize, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        # Multi-tensor operations
        OpImpl(
            op_name="multi_tensor_quantize",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.multi_tensor_quantize, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
        ...
        OpImpl(
            op_name="create_fp8_tensor_meta",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.create_fp8_tensor_meta, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="create_comm_overlap_helper",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.create_comm_overlap_helper, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="create_comm_overlap",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.create_comm_overlap, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
        OpImpl(
            op_name="create_comm_overlap_p2p",
            impl_id="vendor.enflame",
            kind=BackendImplKind.VENDOR,
            fn=_bind_is_available(backend.create_comm_overlap_p2p, is_avail),
            vendor="ENFLAME",
            priority=100,
        ),
