...
"""
Metax vendor backend operator registrations.

This module registers all VENDOR (Metax) implementations from transformer_engine_torch.
"""
...
def register_builtins(registry) -> None:
    ...
    """
    # Import Metax backend to get all the wrapped tex functions
    from .metax import MetaxBackend

    # Create a backend instance to access the methods
    backend = MetaxBackend()

    # Check if Metax is available before registering
