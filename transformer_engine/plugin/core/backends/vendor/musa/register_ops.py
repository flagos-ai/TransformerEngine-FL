...
"""
MUSA vendor backend operator registrations.

This module registers all VENDOR (MUSA) implementations from transformer_engine_torch.
"""
...
def register_builtins(registry) -> None:
    ...
    """
    # Import MUSA backend to get all the wrapped tex functions
    from .musa import MUSABackend

    # Create a backend instance to access the methods
    backend = MUSABackend()

    # Check if MUSA is available before registering
